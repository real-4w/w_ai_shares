    ...
    def fetch_stock_data(self, ticker):
        ...
        try:
            ...
            stock_data = {
                ...
                'Recommendation Mean': recommendation_mean,  # 1=Strong Buy, 5=Strong Sell
    ...
    def display_daily_recommendations(self):
        ...
        for ticker in candidate_tickers:
            ...
            if 'Error' not in stock_data:
                ...
                score = -recommendation_mean if recommendation_mean != 'N/A' else 0  # Lower is better (1=Strong Buy)
                recommendations.append((ticker, score))

        recommendations.sort(key=lambda x: x[1])  # Sort ascending (lower recommendationMean is better)
